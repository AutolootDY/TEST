        ...
        <body>
            ...
            {/* <div className="bg-img"> */}
                <div className="contentsHome">
                    ...
                    <div className="space">
                        <button type="button" className="btn btn-primary btn-lg" onClick={()=>window.location = "/PhysicalTest"} >PhysicalTest</button>
                    </div>

                    <div className="space">
                        <button type="button" className="btn btn-primary btn-lg" onClick={()=>window.location = "/TheoryTest"} >TheoryTest</button>
                    </div>

                    <div className="space">
                        <button type="button" className="btn btn-primary btn-lg" onClick={()=>window.location = "/PracticalTest"} >PracticalTest</button>
                    </div>

                    <div className="space">
                        <button type="button" className="btn btn-primary btn-lg" onClick={()=>window.location = "/TestResultStatus"} >TestResultStatus</button>
                    </div>

                    <div className="space">
                        <button type="button" className="btn btn-primary btn-lg" onClick={()=>window.location = "/TestResultsReport"} >TestResultsReport</button>
                    </div>
